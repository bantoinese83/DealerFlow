      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10 w-full">
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-300 mt-2">Connect DealerFlow AI to your CRM and data sources.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6">
              <h3 className="text-lg font-medium text-white">CDK Global</h3>
              <p className="text-gray-300 mt-2">Two-way sync for leads and activities.</p>
            </Card>
            <Card className="p-6">
              <h3 className="text-lg font-medium text-white">Reynolds & Reynolds</h3>
              <p className="text-gray-300 mt-2">Secure integration via Supabase Edge Functions.</p>
            </Card>
          </div>
        </div>
      </main>
