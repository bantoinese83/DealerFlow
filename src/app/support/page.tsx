      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10 w-full">
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/help" className="glass-effect p-6 rounded-lg border border-[hsl(var(--border))] hover:bg-[hsl(var(--accent))] transition-all duration-200">
              <h3 className="text-lg font-medium text-white">Help Center</h3>
              <p className="text-gray-300 mt-2">Guides and FAQs.</p>
            </Link>
            <Link href="/docs" className="glass-effect p-6 rounded-lg border border-[hsl(var(--border))] hover:bg-[hsl(var(--accent))] transition-all duration-200">
              <h3 className="text-lg font-medium text-white">Documentation</h3>
              <p className="text-gray-300 mt-2">Developer docs and API.</p>
            </Link>
            <Link href="/contact" className="glass-effect p-6 rounded-lg border border-[hsl(var(--border))] hover:bg-[hsl(var(--accent))] transition-all duration-200">
              <h3 className="text-lg font-medium text-white">Contact Us</h3>
              <p className="text-gray-300 mt-2">Get in touch with our team.</p>
            </Link>
          </div>
        </div>
      </main>
